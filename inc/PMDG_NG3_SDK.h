...
#define EVT_OH_CARGO_SMOKE_TEST					(THIRD_PARTY_EVENT_ID_MIN + 905) // 905 - FREIGHTER CARGO SMOKE TEST Switch          -- switch_905_73X
#define EVT_OH_CARGO_SMOKE_BELL_CUTOUT			(THIRD_PARTY_EVENT_ID_MIN + 907) // 907 - FREIGHTER CARGO SMOKE BELL CUT OUT Switch  -- switch_907_73X
#define EVT_OH_CARGO_SMOKE						(THIRD_PARTY_EVENT_ID_MIN + 909) // 909 - FREIGHTER CARGO SMOKE Switch               -- switch_909_73X
#define EVT_OH_CARGO_SMOKE_GUARD				(THIRD_PARTY_EVENT_ID_MIN + 911) // 911 - FREIGHTER CARGO SMOKE Switch GUARD         -- switch_911_73X
#define EVT_OH_LAV_SMOKE_TEST					(THIRD_PARTY_EVENT_ID_MIN + 913) // 913 - FREIGHTER LAV SMOKE TEST Switch            -- switch_913_73X
#define EVT_OH_LAV_SMOKE_BELL_CUTOUT			(THIRD_PARTY_EVENT_ID_MIN + 915) // 915 - FREIGHTER LAV BELL CUT OUT Switch          -- switch_915_73X
