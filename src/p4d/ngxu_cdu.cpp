...
bool NG3_run()
{
    ...
    if (SUCCEEDED(SimConnect_Open(&hSimConnect, "NG3_CDU", NULL, 0, 0, 0)))
    {
        ...
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_H, "#70222");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_I, "#70223");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_J, "#70224");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_K, "#70225");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_L, "#70226");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_M, "#70227");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_N, "#70228");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_O, "#70229");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_P, "#70230");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_Q, "#70231");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_R, "#70232");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_S, "#70233");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_T, "#70234");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_U, "#70235");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_V, "#70236");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_W, "#70237");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_X, "#70238");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_Y, "#70239");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_Z, "#70240");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_SPACE, "#70241");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_DEL, "#70242");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_SLASH, "#70243");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_CLR, "#70244");
        hr = SimConnect_MapClientEventToSimEvent(hSimConnect, EVENT_CDU_L_BRITENESS, "#70245");
